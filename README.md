# KOWASA.NET   [코와사넷](https://www.kowasa.net)  v1.1
...
![3](https://github.com/KYJIN1024/WineProject/assets/111983474/3141d008-29eb-46f6-be4c-b19ee10fae91)
![4](https://github.com/KYJIN1024/WineProject/assets/111983474/1de2a529-7a65-47f0-88d2-9c8920459ebf)
...
그리고 기능테스트 케이스를 작성하면서 구현한 기능이 문제없이 작동하는지 테스트를 진행하였는데 여러기능들에서 오류가 발견되어서 다시 수정하는 과정을 거치면서 테스트의 중요성을 체험할수 있었습니다. 다만 테스트에 대해 뒤늦게 배우게 되어 unit테스트를 거치지않고 프로젝트를 진행한점이 아쉬움에 남습니다.
...
그리고 앞으로 다른 프로젝트를 할때는 TDD를 적용하여 테스트를 꼭 적용해가면서 프로젝트를 진행해야될거같고 꾸준히 자기개발하여 다른 환경이나 도구 및 언어를 사용하여 다른 주제로 프로젝트를 진행볼 계획입니다.
감사합니다.
