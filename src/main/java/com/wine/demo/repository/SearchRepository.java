...
public interface SearchRepository extends JpaRepository<Search, Long> {
	 ...
	 // 주어진 키워드들을 제외한 다른 원료들을 포함하는 검색 결과를 반환하는 메서드
	 ...
	 // 주어진 원료와 지역을 모두 포함하는 검색 결과를 반환하는 메서드
	 ...
	 // 주어진 지역들을 제외한 다른 지역들을 포함하는 검색 결과를 반환하는 메서드
	 ...
	 // 제조사와 지역을 기준으로 중복 없이 검색 결과를 반환하는 메서드
